...
// Check provides a mock function with given fields: hashedPassword, _a1
func (_m *PasswordHasher) Check(hashedPassword string, _a1 string) bool {
...
func (_m *PasswordHasher) Hash(_a0 string) (string, error) {
	ret := _m.Called(_a0)
