...
<img width="1110" alt="image" src="https://github.com/user-attachments/assets/d818a0da-faaa-44da-8191-8856e1cb2458" />
...
Такой метод я сделал, и дополнительную ручку для него GET /pvz/optimized. Скорость работы в среднем стала 1-1,5 секунды, то есть прирост есть. Однако этот метод я сделал только ради эксперемента, поэтому ни unit, ни интеграционными тестами я его не покрывал.
