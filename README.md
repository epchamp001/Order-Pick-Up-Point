...
<img width="1292" alt="image" src="https://github.com/user-attachments/assets/0ace114c-487b-44c4-9ce6-ad2a930c367a" />

Метод получения информации по всем ПВЗ работает довольно медленно (в среднем 1-3 секунды), я думаю, что это обуславливается транзакцией, в которой вызываются очень много методов БД. 
